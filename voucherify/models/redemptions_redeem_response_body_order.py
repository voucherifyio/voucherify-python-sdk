...
class RedemptionsRedeemResponseBodyOrder(BaseModel):
    """
    ...
    items: Optional[List[RedemptionsRedeemResponseBodyOrderItemsItem]] = Field(default=None, description="Array of items applied to the order. It can include up to 500 items.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedemptionsRedeemResponseBodyOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedemptionsRedeemResponseBodyOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [RedemptionsRedeemResponseBodyOrderItemsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
