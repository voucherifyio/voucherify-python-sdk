...
class CampaignsCreateRequestBodyPromotion(BaseModel):
    ...
    """ # noqa: E501
    tiers: Optional[List[PromotionTierCreateParams]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tiers": [PromotionTierCreateParams.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None
        })
        return _obj
