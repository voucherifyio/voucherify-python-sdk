...
class ClientQualificationsCheckEligibilityRequestBody(BaseModel):
    ...
    session: Optional[ClientQualificationsCheckEligibilityRequestBodySession] = None
    ...
    __properties: ClassVar[List[str]] = ["customer", "order", "tracking_id", "scenario", "options", "session", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "session": ClientQualificationsCheckEligibilityRequestBodySession.from_dict(obj["session"]) if obj.get("session") is not None else None,
