...
class RedemptionsRollbackCreateResponseBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "date", "customer_id", "tracking_id", "metadata", "amount", "redemption", "reason", "result", "status", "failure_code", "failure_message", "order", "channel", "customer", "related_object_type", "related_object_id", "voucher", "promotion_tier", "reward", "gift", "loyalty_card", "related_redemptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "channel": RedemptionsRollbackCreateResponseBodyChannel.from_dict(obj["channel"]) if obj.get("channel") is not None else None,
            ...
            "gift": RedemptionsRollbackCreateResponseBodyGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "loyalty_card": RedemptionsRollbackCreateResponseBodyLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            "related_redemptions": RedemptionsRollbackCreateResponseBodyRelatedRedemptions.from_dict(obj["related_redemptions"]) if obj.get("related_redemptions") is not None else None
        })
        return _obj
