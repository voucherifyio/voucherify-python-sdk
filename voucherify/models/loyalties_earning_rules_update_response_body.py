...
class LoyaltiesEarningRulesUpdateResponseBody(BaseModel):
    ...
    pending_points: Optional[LoyaltiesEarningRulesUpdateResponseBodyPendingPoints] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pending_points": LoyaltiesEarningRulesUpdateResponseBodyPendingPoints.from_dict(obj["pending_points"]) if obj.get("pending_points") is not None else None,
