...
class CampaignsImportVoucherItem(BaseModel):
    ...
    category: Optional[StrictStr] = Field(default=None, description="Tag defining the category that this voucher belongs to. Useful when listing vouchers using the [List Vouchers](/api-reference/vouchers/list-vouchers) endpoint.")
    ...
    __properties: ClassVar[List[str]] = ["code", "redemption", "active", "metadata", "category", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "additional_info", "type", "loyalty_card", "gift", "discount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "redemption": CampaignsImportVoucherItemRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
