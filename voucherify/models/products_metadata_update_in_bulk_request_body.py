...
class ProductsMetadataUpdateInBulkRequestBody(BaseModel):
    ...
    """ # noqa: E501
    source_ids: Optional[List[StrictStr]] = Field(default=None, description="Array of unique product source IDs.")
    ...
    __properties: ClassVar[List[str]] = ["source_ids", "metadata"]
