...
with voucherify.ApiClient(configuration) as api_client:
    ...
    qualifications_check_eligibility_request_body = {"scenario":"ALL","options":{"limit":10,"expand":["redeemable"],"sorting_rule":"DEFAULT"}} # QualificationsCheckEligibilityRequestBody | Define order and customer context. (optional)
