...
class LoyaltiesEarningRulesDisableResponseBodySource(BaseModel):
    ...
    object_id: Optional[StrictStr] = Field(default=None, description="A unique campaign identifier assigned by the Voucherify API.")
    object_type: Optional[StrictStr] = Field(default='campaign', description="Defines the object associated with the earning rule. Defaults to `campaign`.")
    __properties: ClassVar[List[str]] = ["banner", "object_id", "object_type"]
