...
class ParameterFiltersListCampaignsTypeConditions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["$in", "$not_in"]
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['AUTO_UPDATE', 'BULK', 'STANDALONE', 'STATIC']):
                raise ValueError("each list item must be one of ('AUTO_UPDATE', 'BULK', 'STANDALONE', 'STATIC')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParameterFiltersListCampaignsTypeConditions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParameterFiltersListCampaignsTypeConditions from a dict"""
        if obj is None:
            return None
