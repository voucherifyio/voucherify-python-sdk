...
class LoyaltiesMembersTransactionsListResponseBody(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[Annotated[str, Field(strict=True)]] = Field(default='list', description="The type of the object represented by JSON.")
    data_ref: Optional[Annotated[str, Field(strict=True)]] = Field(default='data', description="Identifies the name of the attribute that contains the array of transaction objects.")
