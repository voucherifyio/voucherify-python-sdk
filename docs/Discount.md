...
**amount_off_formula** | **str** | Formula used to dynamically calculate the discount. | [optional] 
...
**unit_off_formula** | **str** | Formula used to dynamically calculate the number of units. | [optional] 
...
**percent_off_formula** | **str** | Formula used to dynamically calculate the discount. | [optional] 
...
**fixed_amount_formula** | **str** | Formula used to dynamically calculate the discount. | [optional] 
