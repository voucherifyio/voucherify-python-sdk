...
class CampaignsUpdateRequestBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["discount", "referral_program", "gift", "loyalty_tiers_expiration", "options", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "description", "category", "metadata", "unset_metadata_fields", "category_id"]
