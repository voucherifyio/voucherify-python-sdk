...
class RedeemableVoucher(BaseModel):
    ...
    category: Optional[StrictStr] = Field(default=None, description="The value is null.")
    category_id: Optional[StrictStr] = Field(default=None, description="Unique category ID assigned by Voucherify.")
    categories: Optional[List[Dict[str, Any]]] = Field(default=None, description="Contains an empty array.")
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "campaign", "campaign_id", "category", "category_id", "categories", "type", "discount", "gift", "loyalty_card", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "active", "additional_info", "metadata", "assets", "is_referral_code", "created_at", "updated_at", "referrer_id", "holder_id", "object", "publish", "redemption"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gift": RedeemableVoucherGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "loyalty_card": RedeemableVoucherLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": RedeemableVoucherPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
            "redemption": RedeemableVoucherRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None
        })
        return _obj
