...
class VoucherAssets(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "qr": VoucherAssetsQr.from_dict(obj["qr"]) if obj.get("qr") is not None else None,
            "barcode": VoucherAssetsBarcode.from_dict(obj["barcode"]) if obj.get("barcode") is not None else None
        })
        return _obj
