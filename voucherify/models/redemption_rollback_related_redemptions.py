...
class RedemptionRollbackRelatedRedemptions(BaseModel):
    ...
    """ # noqa: E501
    rollbacks: Optional[List[RedemptionRollbackRelatedRedemptionsRollbacksItem]] = None
    redemptions: Optional[List[RedemptionRollbackRelatedRedemptionsRedemptionsItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rollbacks": [RedemptionRollbackRelatedRedemptionsRollbacksItem.from_dict(_item) for _item in obj["rollbacks"]] if obj.get("rollbacks") is not None else None,
            "redemptions": [RedemptionRollbackRelatedRedemptionsRedemptionsItem.from_dict(_item) for _item in obj["redemptions"]] if obj.get("redemptions") is not None else None
        })
        return _obj
