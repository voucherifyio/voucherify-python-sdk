...
class EarningRuleLoyalty(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": EarningRuleLoyaltyCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "custom_event": EarningRuleLoyaltyCustomEvent.from_dict(obj["custom_event"]) if obj.get("custom_event") is not None else None,
