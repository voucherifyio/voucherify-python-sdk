...
class PromotionsTiersUpdateRequestBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "banner", "action", "metadata", "hierarchy", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "validation_rule_assignments", "category", "category_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "action": PromotionsTiersUpdateRequestBodyAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
