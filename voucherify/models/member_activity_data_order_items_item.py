...
class MemberActivityDataOrderItemsItem(BaseModel):
    """
    ...
    product: Optional[MemberActivityDataOrderItemsItemProduct] = None
    sku: Optional[MemberActivityDataOrderItemsItemSku] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataOrderItemsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataOrderItemsItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "product": MemberActivityDataOrderItemsItemProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "sku": MemberActivityDataOrderItemsItemSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
