...
class LoyaltiesCampaignPendingPointsListResponseBody(BaseModel):
    """
    ...
    data_ref: Optional[StrictStr] = Field(default='data', description="Identifies the name of the attribute that contains the array of pending point objects.")
    data: Optional[List[LoyaltyPendingPoints]] = Field(default=None, description="A dictionary that contains an array of pending point entries. Each entry in the array is a separate pending point object.")
    ...
    more_starting_after: Optional[StrictStr] = Field(default=None, description="Returns an ID that can be used to return another page of results. Use the pending point entry ID in the `starting_after_id` query parameter to display another page of the results starting after the entry with that ID.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoyaltiesCampaignPendingPointsListResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoyaltiesCampaignPendingPointsListResponseBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [LoyaltyPendingPoints.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
