...
class ValidationRulesCreateResponseBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "rules": obj.get("rules"),
            "error": ValidationRulesCreateResponseBodyError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "applicable_to": ValidationRulesCreateResponseBodyApplicableTo.from_dict(obj["applicable_to"]) if obj.get("applicable_to") is not None else None,
