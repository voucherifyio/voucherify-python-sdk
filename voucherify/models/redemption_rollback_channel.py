...
class RedemptionRollbackChannel(BaseModel):
    ...
    """ # noqa: E501
    channel_id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the channel which was used by the user performing the redemption rollback. This is either a user ID from the user using the Voucherify Dashboard or an X-APP-Id of a user using the API.")
