...
class LoyaltiesMembersRedemptionRedeemResponseBodyOrder(BaseModel):
    """
    ...
    customer: Optional[LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer] = None
    referrer: Optional[LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer] = None
    redemptions: Optional[Dict[str, Any]] = None
    items: Optional[List[LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem]] = Field(default=None, description="Array of items applied to the order. It can include up to 500 items.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoyaltiesMembersRedemptionRedeemResponseBodyOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "customer": LoyaltiesMembersRedemptionRedeemResponseBodyOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "referrer": LoyaltiesMembersRedemptionRedeemResponseBodyOrderReferrer.from_dict(obj["referrer"]) if obj.get("referrer") is not None else None,
            "redemptions": obj.get("redemptions"),
            "items": [LoyaltiesMembersRedemptionRedeemResponseBodyOrderItemsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
