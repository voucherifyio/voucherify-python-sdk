...
class MemberActivityDataRedemptionRewardSku(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "source_id", "sku", "product_id", "price", "currency", "attributes", "image_url", "metadata", "created_at", "updated_at", "object"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionRewardSku from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionRewardSku from a dict"""
        if obj is None:
            return None
