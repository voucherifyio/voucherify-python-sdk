...
class CampaignsVouchersCreateCombinedResponseBody(BaseModel):
    ...
    async_action_id: Optional[StrictStr] = Field(default=None, description="The ID of the scheduled asynchronous action.")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.async_action_id is None and "async_action_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gift": CampaignsVouchersCreateCombinedResponseBodyGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "loyalty_card": CampaignsVouchersCreateCombinedResponseBodyLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": CampaignsVouchersCreateCombinedResponseBodyPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
            "redemption": CampaignsVouchersCreateCombinedResponseBodyRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
