...
class MemberActivityDataOrder(BaseModel):
    """
    ...
    items: Optional[List[MemberActivityDataOrderItemsItem]] = Field(default=None, description="Array of items applied to the order. It can include up to 500 items.")
    ...
    customer: Optional[MemberActivityDataOrderCustomer] = None
    referrer: Optional[MemberActivityDataOrderReferrer] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [MemberActivityDataOrderItemsItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "metadata": obj.get("metadata"),
            "object": obj.get("object") if obj.get("object") is not None else 'order',
            "initial_amount": obj.get("initial_amount"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "customer": MemberActivityDataOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "referrer": MemberActivityDataOrderReferrer.from_dict(obj["referrer"]) if obj.get("referrer") is not None else None,
