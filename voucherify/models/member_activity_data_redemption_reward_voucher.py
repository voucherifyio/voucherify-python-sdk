...
class MemberActivityDataRedemptionRewardVoucher(BaseModel):
    """
    MemberActivityDataRedemptionRewardVoucher
    """ # noqa: E501
    id: Optional[StrictStr] = None
    code: Optional[StrictStr] = None
    gift: Optional[MemberActivityDataRedemptionRewardVoucherGift] = None
    discount: Optional[Discount] = None
    loyalty_card: Optional[MemberActivityDataRedemptionRewardVoucherLoyaltyCard] = None
    ...
    referrer_id: Optional[StrictStr] = None
    ...
    redemption: Optional[MemberActivityDataRedemptionRewardVoucherRedemption] = None
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="A set of custom key/value pairs that you can attach to a voucher. The metadata object stores all custom attributes assigned to the voucher. and The metadata object stores all custom attributes assigned to the code. A set of key/value pairs that you can attach to a voucher object. It can be useful for storing additional information about the voucher in a structured format.")
    ...
    publish: Optional[MemberActivityDataRedemptionRewardVoucherPublish] = None
    validation_rules_assignments: Optional[ValidationRulesAssignmentsList] = None
    __properties: ClassVar[List[str]] = ["id", "code", "gift", "discount", "loyalty_card", "type", "campaign", "campaign_id", "is_referral_code", "holder_id", "referrer_id", "category_id", "categories", "active", "created_at", "updated_at", "redemption", "start_date", "expiration_date", "metadata", "object", "category", "validity_timeframe", "validity_day_of_week", "validity_hours", "additional_info", "assets", "publish", "validation_rules_assignments"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionRewardVoucher from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionRewardVoucher from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "code": obj.get("code"),
            "gift": MemberActivityDataRedemptionRewardVoucherGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "discount": Discount.from_dict(obj["discount"]) if obj.get("discount") is not None else None,
            "loyalty_card": MemberActivityDataRedemptionRewardVoucherLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            "type": obj.get("type"),
            ...
            "redemption": MemberActivityDataRedemptionRewardVoucherRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
            ...
            "publish": MemberActivityDataRedemptionRewardVoucherPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
