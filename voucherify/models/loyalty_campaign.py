...
class LoyaltyCampaign(BaseModel):
    ...
    activity_duration_after_publishing: Optional[StrictStr] = Field(default=None, description="Defines the amount of time the campaign will be active in ISO 8601 format after publishing. For example, a campaign with a `duration` of `P24D` will be valid for a duration of 24 days.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "voucher": LoyaltyCampaignVoucher.from_dict(obj["voucher"]) if obj.get("voucher") is not None else None,
