...
class MemberActivityDataRedemptionPreviousOrder(BaseModel):
    """
    ...
    customer: Optional[MemberActivityDataRedemptionPreviousOrderCustomer] = None
    referrer: Optional[MemberActivityDataRedemptionPreviousOrderReferrer] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPreviousOrder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPreviousOrder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "customer": MemberActivityDataRedemptionPreviousOrderCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "referrer": MemberActivityDataRedemptionPreviousOrderReferrer.from_dict(obj["referrer"]) if obj.get("referrer") is not None else None,
