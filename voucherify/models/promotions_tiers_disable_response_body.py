...
class PromotionsTiersDisableResponseBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "action": PromotionsTiersDisableResponseBodyAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "metadata": obj.get("metadata"),
            "hierarchy": obj.get("hierarchy"),
            "promotion_id": obj.get("promotion_id"),
            "campaign": PromotionsTiersDisableResponseBodyCampaign.from_dict(obj["campaign"]) if obj.get("campaign") is not None else None,
            ...
            "summary": PromotionsTiersDisableResponseBodySummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
