...
class MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard(BaseModel):
    """
    ...
    next_expiration_date: Optional[StrictStr] = Field(default=None, description="The next closest date when the next set of points are due to expire.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataTransactionDetailsDestinationVoucherLoyaltyCard from a dict"""
        if obj is None:
            return None
