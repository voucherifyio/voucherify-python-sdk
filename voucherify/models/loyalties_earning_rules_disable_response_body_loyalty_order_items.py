...
class LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItems(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quantity": LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsQuantity.from_dict(obj["quantity"]) if obj.get("quantity") is not None else None,
            "amount": LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "subtotal_amount": LoyaltiesEarningRulesDisableResponseBodyLoyaltyOrderItemsSubtotalAmount.from_dict(obj["subtotal_amount"]) if obj.get("subtotal_amount") is not None else None
        })
        return _obj
