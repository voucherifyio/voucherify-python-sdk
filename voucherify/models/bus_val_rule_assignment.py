...
class BusValRuleAssignment(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for a assignment")
    rule_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for a rule")
    related_object_id: Optional[StrictStr] = Field(default=None, description="The unique identifier for a related object")
    related_object_type: Optional[StrictStr] = Field(default=None, description="The type of related object")
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Timestamp representing the date and time when the object was last updated in ISO 8601 format.")
    object: Optional[StrictStr] = Field(default='validation_rules_assignment', description="The type of the object represented by JSON.")
    validation_status: Optional[StrictStr] = Field(default=None, description="The validation status of the assignment")
    validation_omitted_rules: Optional[List[StrictStr]] = Field(default=None, description="The list of omitted rules")
    __properties: ClassVar[List[str]] = ["id", "rule_id", "related_object_id", "related_object_type", "created_at", "updated_at", "object", "validation_status", "validation_omitted_rules"]
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['validation_rules_assignment']):
    ...
    def validation_status_validate_enum(cls, value):
        ...
        if value not in set(['VALID', 'PARTIALLY_VALID', 'INVALID']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.validation_omitted_rules is None and "validation_omitted_rules" in self.model_fields_set:
