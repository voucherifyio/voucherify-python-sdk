...
class ExportsListResponseBody(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[StrictStr] = Field(default='list', description="The type of the object represented by JSON. This object stores information about exports.")
    data_ref: Optional[StrictStr] = Field(default='exports', description="Identifies the name of the attribute that contains the array of exports.")
    exports: Optional[List[Export]] = Field(default=None, description="An array of export objects.")
    total: Optional[StrictInt] = Field(default=None, description="Total number of exports.")
    __properties: ClassVar[List[str]] = ["object", "data_ref", "exports", "total"]
