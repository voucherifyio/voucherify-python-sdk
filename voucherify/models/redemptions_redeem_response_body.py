...
class RedemptionsRedeemResponseBody(BaseModel):
    ...
    order: Optional[RedemptionsRedeemResponseBodyOrder] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": RedemptionsRedeemResponseBodyOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
