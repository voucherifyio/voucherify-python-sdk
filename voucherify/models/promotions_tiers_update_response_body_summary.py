...
class PromotionsTiersUpdateResponseBodySummary(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "redemptions": PromotionsTiersUpdateResponseBodySummaryRedemptions.from_dict(obj["redemptions"]) if obj.get("redemptions") is not None else None,
            "orders": PromotionsTiersUpdateResponseBodySummaryOrders.from_dict(obj["orders"]) if obj.get("orders") is not None else None
        })
        return _obj
