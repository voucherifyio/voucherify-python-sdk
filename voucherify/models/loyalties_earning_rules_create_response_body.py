...
class LoyaltiesEarningRulesCreateResponseBody(BaseModel):
    ...
    pending_points: Optional[LoyaltiesEarningRulesCreateResponseBodyPendingPoints] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loyalty": LoyaltiesEarningRulesCreateResponseBodyLoyalty.from_dict(obj["loyalty"]) if obj.get("loyalty") is not None else None,
            "event": obj.get("event"),
            "custom_event": LoyaltiesEarningRulesCreateResponseBodyCustomEvent.from_dict(obj["custom_event"]) if obj.get("custom_event") is not None else None,
            "segment": LoyaltiesEarningRulesCreateResponseBodySegment.from_dict(obj["segment"]) if obj.get("segment") is not None else None,
            "loyalty_tier": LoyaltiesEarningRulesCreateResponseBodyLoyaltyTier.from_dict(obj["loyalty_tier"]) if obj.get("loyalty_tier") is not None else None,
            "pending_points": LoyaltiesEarningRulesCreateResponseBodyPendingPoints.from_dict(obj["pending_points"]) if obj.get("pending_points") is not None else None,
            "source": LoyaltiesEarningRulesCreateResponseBodySource.from_dict(obj["source"]) if obj.get("source") is not None else None,
