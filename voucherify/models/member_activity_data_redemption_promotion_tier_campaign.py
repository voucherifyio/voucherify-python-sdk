...
class MemberActivityDataRedemptionPromotionTierCampaign(BaseModel):
    """
    ...
    active: Optional[StrictBool] = Field(default=None, description="A flag indicating whether the campaign is active or not active. A campaign can be disabled even though it's within the active period defined by the `start_date` and `expiration_date` using the [Disable Campaign](/api-reference/disable-campaign) endpoint.    - `true` indicates an *active* campaign - `false` indicates an *inactive* campaign")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPromotionTierCampaign from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPromotionTierCampaign from a dict"""
        if obj is None:
            return None
