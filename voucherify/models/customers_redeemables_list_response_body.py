...
class CustomersRedeemablesListResponseBody(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[StrictStr] = Field(default='list', description="The type of the object represented by JSON. This object stores information about customer redeemables.")
    data_ref: Optional[StrictStr] = Field(default='data', description="Identifies the name of the JSON property that contains the array of redeemables.")
    data: Optional[List[CustomerRedeemable]] = Field(default=None, description="A dictionary that contains an array of redeemables.")
    total: Optional[StrictInt] = Field(default=None, description="Total number of results returned.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CustomerRedeemable.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
