...
class RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct(BaseModel):
    """
    ...
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="A set of custom key/value pairs that you can attach to a product. It can be useful for storing additional information about the product in a structured format. It can be used to create product collections.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedemptionsListResponseBodyRedemptionsItemOrderItemsItemProduct from a dict"""
        if obj is None:
            return None
