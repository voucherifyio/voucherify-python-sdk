...
class SkusListForProduct(BaseModel):
    ...
    data: Optional[List[Sku]] = Field(default=None, description="A dictionary that contains an array of SKUs.")
    total: Optional[StrictInt] = Field(default=None, description="Total number of SKUs in the product.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [Sku.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
