...
class LoyaltiesPointsExpirationExportCreateRequestBodyParametersFilters(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voucher_id": LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersVoucherId.from_dict(obj["voucher_id"]) if obj.get("voucher_id") is not None else None,
            "campaign_id": LoyaltiesPointsExpirationExportCreateRequestBodyParametersFiltersCampaignId.from_dict(obj["campaign_id"]) if obj.get("campaign_id") is not None else None
        })
        return _obj
