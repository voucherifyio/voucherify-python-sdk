...
class SimpleCampaignVoucher(BaseModel):
    """
    ...
    redemption: Optional[SimpleCampaignVoucherRedemption] = None
    code_config: CodeConfig
    __properties: ClassVar[List[str]] = ["type", "discount", "gift", "loyalty_card", "redemption", "code_config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleCampaignVoucher from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleCampaignVoucher from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "redemption": SimpleCampaignVoucherRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
