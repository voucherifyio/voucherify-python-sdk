...
class MemberActivityDataRedemptionVoucher(BaseModel):
    """
    MemberActivityDataRedemptionVoucher
    """ # noqa: E501
    id: Optional[StrictStr] = None
    code: Optional[StrictStr] = None
    gift: Optional[MemberActivityDataRedemptionVoucherGift] = None
    discount: Optional[Discount] = None
    loyalty_card: Optional[MemberActivityDataRedemptionVoucherLoyaltyCard] = None
    ...
    redemption: Optional[MemberActivityDataRedemptionVoucherRedemption] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionVoucher from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionVoucher from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "code": obj.get("code"),
            "gift": MemberActivityDataRedemptionVoucherGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "discount": Discount.from_dict(obj["discount"]) if obj.get("discount") is not None else None,
            "loyalty_card": MemberActivityDataRedemptionVoucherLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            "type": obj.get("type"),
            ...
            "redemption": MemberActivityDataRedemptionVoucherRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
            ...
            "publish": MemberActivityDataRedemptionVoucherPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
