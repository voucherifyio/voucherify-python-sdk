...
class PromotionsStacksCreateResponseBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "tiers", "id", "created_at", "campaign_id", "object", "category_id", "categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tiers": PromotionsStacksCreateResponseBodyTiers.from_dict(obj["tiers"]) if obj.get("tiers") is not None else None,
            "id": obj.get("id"),
