...
class MetadataSchemasListResponseBody(BaseModel):
    ...
    schemas: Optional[List[MetadataSchema]] = Field(default=None, description="Array of metadata schema objects. The metadata schemas are listed by related object properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schemas": [MetadataSchema.from_dict(_item) for _item in obj["schemas"]] if obj.get("schemas") is not None else None,
            "total": obj.get("total")
        })
        return _obj
