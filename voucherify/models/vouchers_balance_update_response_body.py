...
class VouchersBalanceUpdateResponseBody(BaseModel):
    ...
    """ # noqa: E501
    amount: Optional[StrictInt] = Field(default=None, description="The incremental amount added (positive integer) or subtracted (negative integer) to the current balance on the gift card or loyalty card. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.")
    ...
    balance: Optional[StrictInt] = Field(default=None, description="The balance after adding or subtracting a specified amount. The value is multiplied by 100 to represent 2 decimal places. For example `10000 cents` for `$100.00`.")
