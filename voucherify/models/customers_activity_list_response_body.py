...
class CustomersActivityListResponseBody(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[StrictStr] = Field(default='list', description="The type of the object represented by JSON. This object stores information about customer activities in a dictionary.")
    data_ref: Optional[StrictStr] = Field(default='data', description="Identifies the name of the attribute that contains the array of customer activity objects.")
    data: Optional[List[CustomerActivity]] = Field(default=None, description="Array of customer activity objects.")
    ...
    more_starting_after: Optional[StrictStr] = Field(default=None, description="Returns an ID that can be used to return another page of results. Use the event ID in the `starting_after_id` query parameter to display another page of the results starting after the event with that ID.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CustomerActivity.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
