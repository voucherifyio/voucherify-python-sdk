...
class ExportCampaignTransactionsFilters(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["junction", "created_at", "voucher_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportCampaignTransactionsFilters from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportCampaignTransactionsFilters from a dict"""
        if obj is None:
            return None
