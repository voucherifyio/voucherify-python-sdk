...
class ParameterFiltersListCustomerRedeemablesRedeemableObjectConditions(BaseModel):
    ...
    var_is: Optional[StrictStr] = Field(default='voucher', description="Value is exactly this value (single value).", alias="$is")
    is_not: Optional[StrictStr] = Field(default='voucher', description="Results omit this value (single value).", alias="$is_not")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "$is": obj.get("$is") if obj.get("$is") is not None else 'voucher',
