...
class ParameterFiltersListCampaignsVoucherTypeConditions(BaseModel):
    """
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['GIFT_VOUCHER', 'DISCOUNT_VOUCHER', 'LOYALTY_CARD']):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParameterFiltersListCampaignsVoucherTypeConditions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParameterFiltersListCampaignsVoucherTypeConditions from a dict"""
        if obj is None:
            return None
