...
class InapplicableToResultList(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[InapplicableTo]] = Field(default=None, description="Contains array of items to which the discount cannot apply.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [InapplicableTo.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
