...
class RedemptionsGetResponseBodyOrderItemsItem(BaseModel):
    """
    ...
    product: Optional[RedemptionsGetResponseBodyOrderItemsItemProduct] = None
    sku: Optional[RedemptionsGetResponseBodyOrderItemsItemSku] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedemptionsGetResponseBodyOrderItemsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedemptionsGetResponseBodyOrderItemsItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "product": RedemptionsGetResponseBodyOrderItemsItemProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "sku": RedemptionsGetResponseBodyOrderItemsItemSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
