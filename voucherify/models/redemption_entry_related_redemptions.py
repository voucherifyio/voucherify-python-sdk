...
class RedemptionEntryRelatedRedemptions(BaseModel):
    ...
    """ # noqa: E501
    rollbacks: Optional[List[RedemptionEntryRelatedRedemptionsRollbacksItem]] = None
    redemptions: Optional[List[RedemptionEntryRelatedRedemptionsRedemptionsItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rollbacks": [RedemptionEntryRelatedRedemptionsRollbacksItem.from_dict(_item) for _item in obj["rollbacks"]] if obj.get("rollbacks") is not None else None,
            "redemptions": [RedemptionEntryRelatedRedemptionsRedemptionsItem.from_dict(_item) for _item in obj["redemptions"]] if obj.get("redemptions") is not None else None
        })
        return _obj
