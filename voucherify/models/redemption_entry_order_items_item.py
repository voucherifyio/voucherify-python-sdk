...
class RedemptionEntryOrderItemsItem(BaseModel):
    """
    ...
    product: Optional[RedemptionEntryOrderItemsItemProduct] = None
    sku: Optional[RedemptionEntryOrderItemsItemSku] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RedemptionEntryOrderItemsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RedemptionEntryOrderItemsItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "product": RedemptionEntryOrderItemsItemProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "sku": RedemptionEntryOrderItemsItemSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
