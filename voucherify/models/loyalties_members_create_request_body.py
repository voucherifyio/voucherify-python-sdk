...
class LoyaltiesMembersCreateRequestBody(BaseModel):
    ...
    """ # noqa: E501
    voucher: Optional[StrictStr] = Field(default=None, description="Code of voucher being published.")
    ...
    __properties: ClassVar[List[str]] = ["voucher", "source_id", "customer", "metadata", "channel"]
