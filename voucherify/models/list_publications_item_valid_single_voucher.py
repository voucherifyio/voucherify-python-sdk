...
class ListPublicationsItemValidSingleVoucher(BaseModel):
    ...
    metadata: Optional[ListPublicationsItemValidSingleVoucherMetadata] = None
    ...
    vouchers: Optional[List[StrictStr]] = Field(default=None, description="Contains the voucher IDs that was assigned by Voucherify.")
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "created_at", "customer_id", "tracking_id", "metadata", "channel", "source_id", "customer", "vouchers", "vouchers_id", "result", "voucher"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ListPublicationsItemValidSingleVoucherMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
