...
class ParameterFiltersListCustomerRedeemablesCampaignTypeConditions(BaseModel):
    ...
    def var_in_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM']):
    ...
    def var_is_validate_enum(cls, value):
        ...
        if value not in set(['LOYALTY_PROGRAM', 'GIFT_VOUCHERS', 'DISCOUNT_COUPONS', 'REFERRAL_PROGRAM']):
