...
class ValidationRulesAssignmentsList(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[StrictStr] = Field(default='list', description="The type of the object represented by JSON. This object stores information about validation rules assignments.")
    ...
    data: Optional[List[BusValRuleAssignment]] = Field(default=None, description="Contains array of validation rules assignments.")
    total: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Total number of validation rules assignments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [BusValRuleAssignment.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
