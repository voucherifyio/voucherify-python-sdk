...
class ExportsCreateResponseBodyParametersFilters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["junction", "campaign_id", "voucher_id", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "campaign_id": FieldConditions.from_dict(obj["campaign_id"]) if obj.get("campaign_id") is not None else None,
            "voucher_id": FieldConditions.from_dict(obj["voucher_id"]) if obj.get("voucher_id") is not None else None,
