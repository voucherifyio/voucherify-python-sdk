...
class ValidationsValidateRequestBodyRedeemablesItem(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "gift": ValidationsValidateRequestBodyRedeemablesItemGift.from_dict(obj["gift"]) if obj.get("gift") is not None else None,
            "reward": ValidationsValidateRequestBodyRedeemablesItemReward.from_dict(obj["reward"]) if obj.get("reward") is not None else None
        })
        return _obj
