...
with voucherify.ApiClient(configuration) as api_client:
    ...
    segment_id = 'segment_id_example' # str | Filter customers by the segment ID. Warning: Passing additional query parameter filters that are in conflict with the segment filters may return unexpected results. (optional)
 ...
 **segment_id** | **str**| Filter customers by the segment ID. Warning: Passing additional query parameter filters that are in conflict with the segment filters may return unexpected results. | [optional] 
