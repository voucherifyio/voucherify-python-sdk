...
class ParameterFiltersListMemberTransactions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created_at", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ParameterFiltersListMemberTransactions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ParameterFiltersListMemberTransactions from a dict"""
        if obj is None:
            return None
