...
class Bundle(BaseModel):
    ...
    """ # noqa: E501
    quantity: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Determines how many bundles are qualified. If there are missing bundle products, the value is `0`. If the bundle is qualified, the value is `1`.")
    ...
    __properties: ClassVar[List[str]] = ["quantity", "identified", "missing"]
