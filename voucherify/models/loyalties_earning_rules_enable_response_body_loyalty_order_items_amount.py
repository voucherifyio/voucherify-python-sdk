...
class LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmount(BaseModel):
    ...
    applicable_to: Optional[List[LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem]] = Field(default=None, description="Defines products, SKUs, or product collections covered by the earning rule. Can be replaced by `object` and `id` to define only one object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "applicable_to": [LoyaltiesEarningRulesEnableResponseBodyLoyaltyOrderItemsAmountApplicableToItem.from_dict(_item) for _item in obj["applicable_to"]] if obj.get("applicable_to") is not None else None
        })
        return _obj
