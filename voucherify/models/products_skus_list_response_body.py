...
class ProductsSkusListResponseBody(BaseModel):
    ...
    skus: Optional[List[Sku]] = Field(default=None, description="A dictionary that contains an array of SKUs.")
    total: Optional[StrictInt] = Field(default=None, description="Total number of SKUs in the product.")
    __properties: ClassVar[List[str]] = ["object", "data_ref", "skus", "total"]
