...
class QualificationsOptionFiltersCampaignTypeConditions(BaseModel):
    ...
    """ # noqa: E501
    var_is: Optional[List[ParameterCampaignType]] = Field(default=None, alias="$is")
    is_not: Optional[List[ParameterCampaignType]] = Field(default=None, alias="$is_not")
    var_in: Optional[List[ParameterCampaignType]] = Field(default=None, alias="$in")
    not_in: Optional[List[ParameterCampaignType]] = Field(default=None, alias="$not_in")
