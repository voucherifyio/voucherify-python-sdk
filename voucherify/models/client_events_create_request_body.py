...
class ClientEventsCreateRequestBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "referral": ClientEventsCreateRequestBodyReferral.from_dict(obj["referral"]) if obj.get("referral") is not None else None,
            "loyalty": ClientEventsCreateRequestBodyLoyalty.from_dict(obj["loyalty"]) if obj.get("loyalty") is not None else None,
