...
class CampaignVoucher(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of voucher.")
    ...
    __properties: ClassVar[List[str]] = ["type", "discount", "gift", "loyalty_card", "redemption", "code_config", "is_referral_code", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redemption": CampaignVoucherRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
