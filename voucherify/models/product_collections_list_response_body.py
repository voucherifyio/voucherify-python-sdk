...
class ProductCollectionsListResponseBody(BaseModel):
    ...
    """ # noqa: E501
    object: Optional[StrictStr] = Field(default='list', description="The type of the object represented by JSON. This object stores information about product collections.")
    data_ref: Optional[StrictStr] = Field(default='data', description="Identifies the name of the JSON property that contains the array of product collections.")
    data: Optional[List[ProductCollectionsItem]] = Field(default=None, description="A dictionary that contains an array of product collections and their details.")
    total: Optional[StrictInt] = Field(default=None, description="Total number of product collections.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ProductCollectionsItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
