...
class LoyaltiesTransactionsListResponseBody(BaseModel):
    """
    ...
    data_ref: Optional[StrictStr] = Field(default='data', description="Identifies the name of the attribute that contains the array of transaction objects.")
    data: Optional[List[LoyaltyCardTransaction]] = Field(default=None, description="A dictionary that contains an array of transactions. Each entry in the array is a separate transaction object.")
    ...
    more_starting_after: Optional[StrictStr] = Field(default=None, description="Returns an ID that can be used to return another page of results. Use the transaction ID in the `starting_after_id` query parameter to display another page of the results starting after the transaction with that ID.")
    __properties: ClassVar[List[str]] = ["object", "data_ref", "data", "has_more", "more_starting_after"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoyaltiesTransactionsListResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoyaltiesTransactionsListResponseBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [LoyaltyCardTransaction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
