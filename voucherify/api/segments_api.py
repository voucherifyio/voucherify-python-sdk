...
class SegmentsApi:
    ...
    def create_segment(
        self,
        segments_create_request_body: Annotated[Optional[SegmentsCreateRequestBody], Field(description="Specify the boundary conditions for the customer segment.")] = None,
        ...
        _param = self._create_segment_serialize(
            segments_create_request_body=segments_create_request_body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '2XX': "SegmentsCreateResponseBody",
        }
    ...
    def _create_segment_serialize(
        ...
        if segments_create_request_body is not None:
            _body_params = segments_create_request_body
    ...
    def delete_segment(
        self,
        segment_id: Annotated[StrictStr, Field(description="A unique customer segment ID.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _delete_segment_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/segments/{segmentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
