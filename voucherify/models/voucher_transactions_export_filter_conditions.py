...
class VoucherTransactionsExportFilterConditions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["voucher_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "voucher_id": VoucherTransactionsExportFilterConditionsVoucherId.from_dict(obj["voucher_id"]) if obj.get("voucher_id") is not None else None
        })
        return _obj
