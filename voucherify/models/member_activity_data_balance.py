...
class MemberActivityDataBalance(BaseModel):
    """
    ...
    related_object: Optional[MemberActivityDataBalanceRelatedObject] = None
    __properties: ClassVar[List[str]] = ["amount", "points", "type", "total", "object", "balance", "operation_type", "related_object"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataBalance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataBalance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "related_object": MemberActivityDataBalanceRelatedObject.from_dict(obj["related_object"]) if obj.get("related_object") is not None else None
        })
        return _obj
