...
class ValidationsRedeemableInapplicableResultDetails(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Generic message from the `message` string shown in the `error` object or the message configured in a validation rule.")
    key: Optional[StrictStr] = Field(default=None, description="Generic message from the `key` string shown in the `error` object.")
