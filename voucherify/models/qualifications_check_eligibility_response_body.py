...
class QualificationsCheckEligibilityResponseBody(BaseModel):
    ...
    order: Optional[QualificationsCheckEligibilityResponseBodyOrder] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "order": QualificationsCheckEligibilityResponseBodyOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
