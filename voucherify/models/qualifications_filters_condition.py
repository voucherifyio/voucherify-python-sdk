...
class QualificationsFiltersCondition(BaseModel):
    ...
    """ # noqa: E501
    var_is: Optional[List[StrictStr]] = Field(default=None, alias="$is")
    is_not: Optional[List[StrictStr]] = Field(default=None, alias="$is_not")
    ...
    not_in: Optional[List[StrictStr]] = Field(default=None, alias="$not_in")
    __properties: ClassVar[List[str]] = ["$is", "$is_not", "$has_value", "$is_unknown", "$in", "$not_in"]
