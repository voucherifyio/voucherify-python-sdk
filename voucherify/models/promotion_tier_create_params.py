...
class PromotionTierCreateParams(BaseModel):
    ...
    validation_rules: Optional[List[StrictStr]] = Field(default=None, description="Array containing the ID of the validation rule associated with the promotion tier.")
    ...
    category: Optional[StrictStr] = Field(default=None, description="Assign category to the promotion tier.")
    category_id: Optional[StrictStr] = Field(default=None, description="Instead of using the category name, you can alternatively assign a new category to a promotion tier using a unique category ID, i.e. `cat_0c9da30e7116ba6bba`.")
    __properties: ClassVar[List[str]] = ["name", "banner", "action", "metadata", "validation_rules", "active", "hierarchy", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "category", "category_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "action": PromotionTierCreateParamsAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
