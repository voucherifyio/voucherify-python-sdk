...
class MemberActivityDataRedemptionOrderItemsItem(BaseModel):
    """
    ...
    object: Optional[StrictStr] = 'order_item'
    ...
    quantity: Optional[StrictInt] = Field(default=None, description="Quantity of the particular item in the cart. and The quantity of the particular item in the cart.")
    ...
    discount_quantity: Optional[StrictInt] = Field(default=None, description="Number of discounted items. and Number of dicounted items.")
    ...
    amount: Optional[StrictInt] = Field(default=None, description="Total amount of the order item (price * quantity). and The total amount of the order item (price * quantity).")
    ...
    applied_discount_amount: Optional[StrictInt] = Field(default=None, description="Order-level discount amount applied in the transaction. and This field shows the order-level discount applied.")
    ...
    product: Optional[MemberActivityDataRedemptionOrderItemsItemProduct] = None
    sku: Optional[MemberActivityDataRedemptionOrderItemsItemSku] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "object", "source_id", "related_object", "product_id", "sku_id", "quantity", "applied_quantity", "applied_quantity_amount", "discount_quantity", "applied_discount_quantity", "amount", "discount_amount", "applied_discount_amount", "price", "subtotal_amount", "initial_quantity", "initial_amount", "product", "sku", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionOrderItemsItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionOrderItemsItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "product": MemberActivityDataRedemptionOrderItemsItemProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "sku": MemberActivityDataRedemptionOrderItemsItemSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
