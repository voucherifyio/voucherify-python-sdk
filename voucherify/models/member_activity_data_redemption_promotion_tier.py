...
class MemberActivityDataRedemptionPromotionTier(BaseModel):
    """
    ...
    campaign: Optional[MemberActivityDataRedemptionPromotionTierCampaign] = None
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="A set of custom key/value pairs that you can attach to a promotion tier. The metadata object stores all custom attributes assigned to the promotion tier. and The metadata object stores all custom attributes assigned to the promotion tier. A set of key/value pairs that you can attach to a promotion tier object. It can be useful for storing additional information about the promotion tier in a structured format.")
    ...
    action: Optional[MemberActivityDataRedemptionPromotionTierAction] = None
    ...
    summary: Optional[MemberActivityDataRedemptionPromotionTierSummary] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "banner", "campaign", "metadata", "created_at", "updated_at", "action", "hierarchy", "promotion_id", "campaign_id", "active", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "summary", "object", "validation_rule_assignments", "category_id", "categories"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPromotionTier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberActivityDataRedemptionPromotionTier from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "campaign": MemberActivityDataRedemptionPromotionTierCampaign.from_dict(obj["campaign"]) if obj.get("campaign") is not None else None,
            "metadata": obj.get("metadata"),
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "action": MemberActivityDataRedemptionPromotionTierAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            ...
            "summary": MemberActivityDataRedemptionPromotionTierSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
