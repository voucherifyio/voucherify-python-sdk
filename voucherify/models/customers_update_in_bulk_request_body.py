...
class CustomersUpdateInBulkRequestBody(BaseModel):
    ...
    """ # noqa: E501
    source_id: Optional[StrictStr] = Field(default=None, description="Unique customer source ID.")
    ...
    __properties: ClassVar[List[str]] = ["source_id", "name", "description", "email", "phone", "birthday", "birthdate", "address", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": CustomersUpdateInBulkRequestBodyAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
