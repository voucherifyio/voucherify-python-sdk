...
class SimpleRedemptionRewardResult(BaseModel):
    ...
    object: Optional[StrictStr] = Field(default='reward', description="The type of the object represented by the JSON. This object stores information about the reward.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product": SimpleProduct.from_dict(obj["product"]) if obj.get("product") is not None else None,
            "sku": SimpleSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
