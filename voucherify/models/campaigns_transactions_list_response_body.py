...
class CampaignsTransactionsListResponseBody(BaseModel):
    """
    ...
    data: Optional[List[VoucherTransaction]] = Field(default=None, description="A dictionary that contains an array of transactions. Each entry in the array is a separate transaction object.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CampaignsTransactionsListResponseBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CampaignsTransactionsListResponseBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [VoucherTransaction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
