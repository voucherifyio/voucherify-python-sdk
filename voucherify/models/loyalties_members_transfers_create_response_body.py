...
class LoyaltiesMembersTransfersCreateResponseBody(BaseModel):
    ...
    validity_day_of_week: List[StrictInt] = Field(description="Integer array corresponding to the particular days of the week in which the voucher is valid.  - `0` Sunday - `1` Monday - `2` Tuesday - `3` Wednesday - `4` Thursday - `5` Friday - `6` Saturday")
    ...
    active: Optional[StrictStr] = Field(default=None, description="A flag to toggle the voucher on or off. You can disable a voucher even though it's within the active period defined by the start_date and expiration_date.  - `true` indicates an active voucher - `false` indicates an inactive voucher")
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "campaign", "campaign_id", "category", "category_id", "categories", "type", "loyalty_card", "start_date", "expiration_date", "validity_timeframe", "validity_day_of_week", "validity_hours", "publish", "redemption", "active", "additional_info", "metadata", "assets", "is_referral_code", "holder_id", "updated_at", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loyalty_card": LoyaltiesMembersTransfersCreateResponseBodyLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltiesMembersTransfersCreateResponseBodyPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
            "redemption": LoyaltiesMembersTransfersCreateResponseBodyRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None,
            "active": obj.get("active"),
            "additional_info": obj.get("additional_info"),
            "metadata": obj.get("metadata"),
            "assets": LoyaltiesMembersTransfersCreateResponseBodyAssets.from_dict(obj["assets"]) if obj.get("assets") is not None else None,
