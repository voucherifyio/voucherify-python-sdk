...
[**update_voucher_balance**](VouchersApi.md#update_voucher_balance) | **POST** /v1/vouchers/{code}/balance | Adjust Voucher Balance
...
> VouchersImportCsvCreateResponseBody import_vouchers_using_csv(file=file, webhooks_enable=webhooks_enable)
...
with voucherify.ApiClient(configuration) as api_client:
    ...
    webhooks_enable = True # bool | Triggers a webhook sendout for new and updated vouchers if the voucher created and voucher updated webhooks are configured in Project settings. (optional)

    try:
        # Import Vouchers using CSV
        api_response = api_instance.import_vouchers_using_csv(file=file, webhooks_enable=webhooks_enable)
 ...
 **webhooks_enable** | **bool**| Triggers a webhook sendout for new and updated vouchers if the voucher created and voucher updated webhooks are configured in Project settings. | [optional] 
