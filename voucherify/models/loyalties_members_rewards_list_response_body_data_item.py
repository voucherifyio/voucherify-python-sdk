...
class LoyaltiesMembersRewardsListResponseBodyDataItem(BaseModel):
    ...
    object: Optional[StrictStr] = Field(default='loyalty_reward', description="The type of the object represented by JSON.")
    __properties: ClassVar[List[str]] = ["reward", "assignment", "object"]
    ...
    def object_validate_enum(cls, value):
        ...
        if value not in set(['loyalty_reward']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignment": RewardAssignment.from_dict(obj["assignment"]) if obj.get("assignment") is not None else None,
