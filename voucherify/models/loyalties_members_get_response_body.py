...
class LoyaltiesMembersGetResponseBody(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gift": obj.get("gift"),
            "loyalty_card": LoyaltiesMembersGetResponseBodyLoyaltyCard.from_dict(obj["loyalty_card"]) if obj.get("loyalty_card") is not None else None,
            ...
            "publish": LoyaltiesMembersGetResponseBodyPublish.from_dict(obj["publish"]) if obj.get("publish") is not None else None,
            "redemption": LoyaltiesMembersGetResponseBodyRedemption.from_dict(obj["redemption"]) if obj.get("redemption") is not None else None
        })
        return _obj
